...
{
    public class HukukMahkemesiController : Controller
    {
        private readonly AuthDbContext _context;
        private readonly IWebHostEnvironment _hostEnvironment;

        public HukukMahkemesiController(AuthDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
            _hostEnvironment = hostEnvironment;
        }

        // GET: HukukMahkemesi/Create
        public IActionResult HukukMahkemesiDosyaEkle()
        {
            return View();
        }
        ...
        public async Task<IActionResult> HukukMahkemesiDosyaEkle(DosyalarViewModel dosyaViewModel)
        {
            Dosyalar yeniDoysa;
            if (ModelState.IsValid)
            {
                ...
                yeniDoysa = new Dosyalar
                {
                    ...
                    MuvekkilKonumuId = Convert.ToInt32(HttpContext.Request.Form["hukukMahkemesiMuvekkilKonumuIdDropDown"]),
