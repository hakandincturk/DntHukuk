...
namespace DntHukuk.Web.Controllers
{
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"(Id = {id}) id'sine sahip rol bulunamadı.";
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Id = {model.Id}) id'sine sahip rol bulunamadı.";
                return View("NotFound");
            }
            else
            {
        ...
        public async Task<IActionResult> EditUsersInRole(string roleId)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Id = {roleId}) id'sine sahip rol bulunamadı.";
                return View("NotFound");
            }
